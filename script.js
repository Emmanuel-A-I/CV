...
var typed = new Typed('.typing', { strings: ["", "a debate coach", "An expert in musicology", "A Strategy and Innovation Consultant", "An Interdisciplinary Program Leader"], typeSpeed: 100, Backspeed: 60, loop: true })
...
function check(){
    alert("Invalid Request: Kindly contact me personaly for my CV. Thanks")
}